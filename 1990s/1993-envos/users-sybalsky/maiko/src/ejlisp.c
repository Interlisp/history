/* @(#) ejlisp.c Version 1.2 (4/21/92). copyright venue & Fuji Xerox  */
static char *id = "@(#) ejlisp.c	1.2 4/21/92	(venue & Fuji Xerox)";
static char *id = "@(#) ejlisp.c 1.6  7/1/91 13:48:43 ";
/*  (c) CopyRight Fuji Xerox 1991  Maiko for VISION Project */
/* FILE: ejlisp.c REL.1 SCCSID:1.6  */
/* SCCS file: /medley/project1/emul/SCCS/s.ejlisp.c  */
