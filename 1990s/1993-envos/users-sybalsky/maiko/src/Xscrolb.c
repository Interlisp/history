/* @(#) Xscrolb.c Version 1.4 (11/25/92). copyright venue & Fuji Xerox  */
static char *id = "@(#) Xscrolb.c	1.4 11/25/92	(venue & Fuji Xerox)";
/*
*
*
...
Move_ScrollBar( display, direction )
     Display *display;
     int direction;
  {
    ...
    if( direction == VERTICAL )
      {
	ResizeWindow( display, &Vert_Scroll_Bar );
      }
    else
      { /* direction == HORIZONTAL */
	ResizeWindow( display, &Horiz_Scroll_Bar );
      } /* end if(direction) */
