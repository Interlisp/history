/* @(#) testdsp.c Version 1.1 (4/21/92). copyright venue & Fuji Xerox  */
static char *id = "@(#) testdsp.c	1.1 4/21/92	(venue & Fuji Xerox)";
/* @(#) testdsp.c Version 1.1 (4/21/92). copyright envos & Fuji Xerox  */
static char *id = "@(#) testdsp.c	1.1 4/21/92		(envos & Fuji Xerox)";
/*
