/* @(#) ocrproc.c Version 1.3 (11/25/92). copyright venue & Fuji Xerox  */
static char *id = "@(#) ocrproc.c	1.3 11/25/92	(venue & Fuji Xerox)";
static char *id = "@(#) ocrproc.c 1.1  7/1/91 11:20:50 ";
/*  (c) CopyRight Fuji Xerox 1991  Maiko for VISION Project */
/* FILE: ocrproc.c REL.1 SCCSID:1.1  */
/* SCCS file: /medley/project1/emul/SCCS/s.ocrproc.c  */
