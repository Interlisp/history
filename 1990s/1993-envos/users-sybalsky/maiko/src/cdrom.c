/* @(#) cdrom.c Version 1.2 (4/21/92). copyright venue & Fuji Xerox  */
static char *id = "@(#) cdrom.c	1.2 4/21/92	(venue & Fuji Xerox)";
static char *id = "@(#) cdrom.c 1.1  6/26/91 10:59:36 ";
/*  (c) CopyRight Fuji Xerox 1991  Maiko for VISION Project */
/* FILE: cdrom.c REL.1 SCCSID:1.1  */
/* SCCS file: /medley/project1/emul/SCCS/s.cdrom.c  */
...
static int cdrom_init_drv(args)
	LispPTR	*args;
/*
