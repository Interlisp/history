...
lbl:									\
    asm volatile("							\n\
	.align 4							\n\
//." lpfx "120:				// fn is compiled.		\n\
//	andl $16777215,%1	// LOCFNCELL=				\n\
//	movl %1,%%ecx							\n\
." lpfx "120:	andl $16777215,%%eax					\n\
	movl %%eax,%1							\n\
	addl %%eax,%%eax						\n\
	addl Lisp_world,%%eax						\n\
	movl %%eax,%0		// to -80				\n\
...
//	movl %%ecx,%0	// result in -88				\n\
//// REplacing with a REP 12/27/91 jds					\n\
//	testl %%ecx,%%ecx	// if result >= 0			\n\
//	jl ." lpfx "127			assume no PVs is uncommon.	\n\
			// then...					\n\
...
//	js ." lpfx "127							\n\
//	.align 4							\n\
//." lpfx "132:		// while --result >= 0 (-- is above)		\n\
