/* @(#) ocr.c Version 1.3 (2/8/93). copyright venue & Fuji Xerox  */
static char *id = "@(#) ocr.c	1.3 2/8/93	(venue & Fuji Xerox)";
static char *id = "@(#) ocr.c 1.1  7/1/91 11:20:41 ";
/*  (c) CopyRight Fuji Xerox 1991  Maiko for VISION Project */
/* FILE: ocr.c REL.1 SCCSID:1.1  */
/* SCCS file: /medley/project1/emul/SCCS/s.ocr.c  */
 ...
 *
 *                                Last edited: 07/01/91 11:09:06 by nm
 */
