/* @(#) truecolor.c Version 1.3 (11/25/92). copyright venue & Fuji Xerox  */
static char *id = "@(#) truecolor.c	1.3 11/25/92	(venue & Fuji Xerox)";
static char *id = "@(#) truecolor.c 1.2  7/9/91 17:05:49 ";
/*  (c) CopyRight Fuji Xerox 1991  Maiko for VISION Project */
/* FILE: truecolor.c REL.1 SCCSID:1.2  */
/* SCCS file: /tmp_mnt/net/vogue/project1/emul/SCCS/s.truecolor.c  */
