/* @(#) picture.c Version 1.4 (2/8/93). copyright venue & Fuji Xerox  */
static char *id = "@(#) picture.c	1.4 2/8/93	(venue & Fuji Xerox)";
static char *id = "@(#) picture.c 1.2  6/28/91 16:42:22 ";
/*  (c) CopyRight Fuji Xerox 1991  Maiko for VISION Project */
/* FILE: picture.c REL.1 SCCSID:1.2  */
/* SCCS file: /tmp_mnt/net/vogue/project1/emul/SCCS/s.picture.c  */
