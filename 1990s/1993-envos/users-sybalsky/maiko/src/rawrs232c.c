/* @(#) rawrs232c.c Version 1.2 (4/21/92). copyright venue & Fuji Xerox  */
static char *id = "@(#) rawrs232c.c	1.2 4/21/92	(venue & Fuji Xerox)";
static char *id = "@(#) rawrs232c.c 1.1  4/12/91 10:59:03 ";
/*  (c) CopyRight Fuji Xerox 1991  Maiko for VISION Project */
/* FILE: rawrs232c.c REL.1 SCCSID:1.1  */
/* SCCS file: /medley/project1/emul/SCCS/s.rawrs232c.c  */
