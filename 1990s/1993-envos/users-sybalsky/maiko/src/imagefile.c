/* @(#) imagefile.c Version 1.2 (4/21/92). copyright venue & Fuji Xerox  */
static char *id = "@(#) imagefile.c	1.2 4/21/92	(venue & Fuji Xerox)";
static char *id = "@(#) imagefile.c 1.1  6/13/91 10:47:29 ";
/*  (c) CopyRight Fuji Xerox 1991  Maiko for VISION Project */
/* FILE: imagefile.c REL.1 SCCSID:1.1  */
/* SCCS file: /tmp_mnt/net/vogue/project1/emul/SCCS/s.imagefile.c  */
