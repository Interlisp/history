/* @(#) lispXdefaults.h Version 1.2 (4/19/90). copyright Venue & Fuji Xerox  */
/*
*
*
...
#define WINDOW_NAME    "Xerox Lisp (C) Copyright 1989 by Envos and Fuji Xerox"
#define ICON_NAME      "Xerox Lisp"
