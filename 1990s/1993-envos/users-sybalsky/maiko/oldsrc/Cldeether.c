/* @(#) Cldeether.c Version 1.2 (4/20/90). copyright venue & Fuji Xerox  */
static char *id = "@(#) Cldeether.c	1.2 4/20/90	(venue & Fuji Xerox)";

/*
 *
 *	Cldeether.c
 *	Kick starter for COLOR emulator
 *	Copyright (C) 1990 by venue &Fuji Xerox Co.  All rights reserved.
 */
