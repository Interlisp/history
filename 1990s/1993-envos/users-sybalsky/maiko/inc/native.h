/* @(#) native.h Version 1.1 (4/21/92). copyright Venue & Fuji Xerox  */
/* This is G-file @(#) native.h Version 2.16 (6/24/88). copyright Xerox & Fuji Xerox  */
/* File: native.h - created Jan 29, 1988 */
